...
def create_left_panel(parent):
    ...
    search_buttons_frame = Frame(search_frame, bg='#3A0C60')
    search_buttons_frame.grid(row=1, column=0, sticky='nsew')
    Label(search_buttons_frame, text="Buttons_to_search", font=("Arial", 14), fg='white', bg='#3A0C60').pack()

    pinned_playlist_frame = Frame(left_frame, bg='#3A0C60')
    pinned_playlist_frame.grid(row=1, column=0, sticky='nsew')

    Label(pinned_playlist_frame, text="Playlists", font=("Arial", 14), fg='white', bg='#3A0C60').pack()
