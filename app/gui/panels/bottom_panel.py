from tkinter import Frame, Label, Scale, HORIZONTAL, FLAT, ACTIVE
...
def create_bottom_panel(parent, song_listbox):
    ...
    try:
        ...
        next_button_img = create_next_button.__globals__['load_next_button']()
        previous_button_img = create_previous_button.__globals__['load_previous_button']()
    ...
    def play_pause_command():
        ...
        is_playing = play_pause_song(
            song_listbox.get(ACTIVE), is_playing, play_pause_button, play_button_img, pause_button_img
        )
    ...
    play_pause_button = create_play_pause_button(bottom_frame_mid, lambda e=None: play_pause_command())
    ...
    progress_slider = Scale(
        ...
        command=lambda value: slide_music(
            value,
            time_elapsed_label,
            time_elapsed_label,
            bottom_center_bar
